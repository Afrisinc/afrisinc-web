            ...
            {products.map((product, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={index % 2 === 1 ? "lg:order-2" : ""}>
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <span
                        ...
                        style={{
                          background: product.status === "Live" ? "hsl(var(--forest) / 0.15)" : product.status === "Beta" ? "hsl(var(--primary) / 0.15)" : "hsl(var(--muted))",
                          color: product.status === "Live" ? "hsl(var(--forest))" : product.status === "Beta" ? "hsl(var(--primary))" : "hsl(var(--muted-foreground))",
                        }}
                      >
                        {product.status}
                      </span>
                  ...
                  {/* Features card */}
                  <div className={`rounded-2xl border border-border bg-card p-8 ${index % 2 === 1 ? "lg:order-1" : ""}`}>
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <p className="text-background/50 text-sm leading-relaxed max-w-sm">
              Choose the products that fit your business needs. Bundle multiple products
