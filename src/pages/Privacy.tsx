        ...
        <div className="container mx-auto px-6 pt-32 pb-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground leading-[1.75] max-w-2xl mt-10 animate-fade-up animation-delay-200">
              We believe transparency builds trust. This page explains exactly how we collect, use, and
          ...
          <div className="grid lg:grid-cols-[250px_1fr] gap-16 lg:gap-20">
            ...
            <aside className="lg:sticky lg:top-28 h-fit">
              <div className="rounded-2xl border border-border bg-muted/30 p-6">
                <p className="text-xs uppercase tracking-[0.18em] font-semibold text-muted-foreground mb-6">
                  On This Page
                </p>
            ...
            <div className="space-y-20">
              ...
              <section id="intro" className="scroll-mt-28">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">Last updated: April 2026</p>
                <div className="space-y-5 text-muted-foreground leading-relaxed">
                  <p>
                    Afrisinc ("we," "us," "our," or "Company") operates the Afrisinc website (the "Site").
                    This privacy policy explains how we collect, use, disclose, and safeguard your information
                    when you visit our website.
                  </p>
                  <p>
                    We're committed to being transparent about what data we collect and why. If our practices
                    ever change, we'll update this policy and notify you. Your privacy matters. Let's keep it
                    simple.
                  </p>
                </div>
              </section>
                ...
                <div className="space-y-8">
                  <div className="border-l-4 border-[hsl(22_88%_52%)] pl-6 py-2">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-3">
                      When you use our contact form, subscribe to our newsletter, or reach out to us, we
                      collect:
                    </p>
                    <ul className="space-y-2 text-muted-foreground leading-relaxed">
                      <li className="flex gap-3">
                        ...
                        <span>
                          <strong>Contact information:</strong> name, email, company, phone (if provided)
                        </span>
                      </li>
                      <li className="flex gap-3">
                        <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                        <span>
                          <strong>Message content:</strong> anything you choose to tell us
                        </span>
                      </li>
                      <li className="flex gap-3">
                        <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                        <span>
                          <strong>Preferences:</strong> newsletter subscription opt-ins
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="border-l-4 border-[hsl(200_97%_45%)] pl-6 py-2">
                    ...
                    <ul className="space-y-2 text-muted-foreground leading-relaxed">
                      <li className="flex gap-3">
                        <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                        <span>
                          <strong>Usage data:</strong> pages visited, time spent, links clicked
                        </span>
                      </li>
                      <li className="flex gap-3">
                        <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                      ...
                      <li className="flex gap-3">
                        <span className="flex-shrink-0 w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                        <span>
                          <strong>Network data:</strong> IP address (anonymized), referrer source
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <section id="analytics" className="scroll-mt-28">
                ...
                <div className="space-y-5 text-muted-foreground leading-relaxed mb-8">
                  <p>
                    We use Google Analytics 4 to understand how visitors interact with our site. This helps us
                    improve the experience for everyone.
                  </p>
                  <p>
                    <strong className="text-foreground">What we track:</strong> page views, clicks, form
                    submissions, scroll depth, and time spent on pages. We use this data to find what's
                    working and what isn't.
                  </p>
                  <p>
                    <strong className="text-foreground">Your control:</strong> You choose whether to allow
                    analytics when you first visit. You can change your preference anytime in the cookie
                ...
                <div className="rounded-xl bg-muted/30 border border-border p-6 md:p-8">
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    ...
                    By GDPR standards, we ask for your permission before tracking. Analytics storage is denied
              ...
              <section id="cookies" className="scroll-mt-28">
                ...
                <div className="space-y-5 text-muted-foreground leading-relaxed">
                  <p>
                    Cookies are small files stored on your device. We use them to remember your preferences
                    and track site usage for analytics.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p>
                        These are required for the site to function (like your session). We use them without
                        asking.
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        . Delete this to see the banner again.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <section id="rights" className="scroll-mt-28">
                ...
                <div className="space-y-5 text-muted-foreground leading-relaxed mb-8">
                  <p>You have rights over your data. Here's what you can do anytime:</p>
                </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div
                      key={idx}
                      className="rounded-xl border border-border bg-card p-6 hover:border-primary/25 transition-all duration-300"
                    >
              ...
              <section id="gdpr" className="scroll-mt-28">
                ...
                <div className="space-y-5 text-muted-foreground leading-relaxed">
                  <p>
                    If you're in the EU or any jurisdiction with strong privacy laws (GDPR, CCPA, etc.), those
                  ...
                  <div className="rounded-xl bg-muted/30 border border-border p-6 md:p-8 space-y-4">
                    <div>
                      ...
                      <p className="text-sm">
                        We process your data based on your consent (when you submit a form) or legitimate
                        interest (analytics to improve our site). We never sell or share your data with third
                        parties.
                      </p>
                    </div>
                    ...
                    <div className="pt-4 border-t border-border">
                      ...
                      <p className="text-sm">
                        We keep contact form data for 90 days after our last conversation. Analytics data is
                        kept for 14 months. After that, it's deleted.
                      </p>
                    </div>
                    ...
                    <div className="pt-4 border-t border-border">
                      ...
                      <p className="text-sm">
                        Your data may be processed outside your country. We use standard contractual clauses
              ...
              <section className="mt-20 pt-20 border-t border-border">
                <div className="rounded-xl bg-muted/30 border border-border p-6 md:p-8">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    We may update this policy as our practices change or laws evolve. If we make material
                    changes, we'll notify you by email or prominent notice on the site. Your continued use of
                    the site after changes means you accept the new policy.
                  </p>
                </div>
              </section>
            </div>
